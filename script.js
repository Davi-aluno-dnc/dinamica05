...
const modalElelement = document.querySelector("#modal");
...
function showModal(index) {
  ...
  modalElelement.innerHTML = ` 
    ...
    `;
    modalElelement.style.visibility = "visible";
}
...
function closeModal() {
  modalElelement.style.visibility = "hidden";
}
